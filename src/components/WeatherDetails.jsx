        ...
        <div className="grid grid-cols-2 p-10 gap-4">
          <div className="bg-blue-100 text-black font-bold text-xl p-2 rounded-md">
            ...
            <div className="flex flex-col items-center justify-center">
              {/* Latitude input */}
              <input
                className="border-2 border-black p-2 m-2 rounded-md text-sm sm:text-base w-full"
                type="text"
              ...
              <button
                className="bg-blue-500 text-white font-bold w-20 py-2 text-sm  rounded-md w-full sm:w-20 sm:py-2 sm:text-base"
                onClick={() => {
                  fetchWeatherData();
                }}
              >
          ...
          <div className="bg-blue-100 text-white font-bold text-xl p-2 rounded-md">
            ...
            {weatherData && (
              <div className="flex justify-center">
                <div className="p-2 m-10 text-gray-500 font-bold text-sm sm:text-xl ">
